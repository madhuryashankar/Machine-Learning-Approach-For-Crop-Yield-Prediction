...
{
    public partial class PaddyYield : System.Web.UI.Page
    {
        ...
        {
            string FileName = "PaddyTestingDataset_Mysuru.xls";

            string Extension = ".xls";

            string FolderPath = ConfigurationManager.AppSettings["FolderPath"];

            string _Location = "PaddyTestingDataset_Mysuru";
        ...
        {
            string FileName = "PaddyTrainingDataset_Mysuru.xls";

            string Extension = ".xls";

            string FolderPath = ConfigurationManager.AppSettings["FolderPath"];

            string _Location = "PaddyTrainingDataset_Mysuru";
        ...
        protected void btnResults_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Results_Paddy.aspx");
        }               
