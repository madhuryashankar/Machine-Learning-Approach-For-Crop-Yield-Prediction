<%@ Page Title="" Language="C#" MasterPageFile="~/AgriDept/StaffMasterpage.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="agricultureProject.AgriDept.Account" %>
...
<asp:Panel ID="panelUpdatePassword" runat="server">
  ...
  <div class="article">
          <h2><span>Update</span> Department Password!!!</h2>
          <hr />
      ...
      <table style="width: 65%;">
       ...
       <br />
              ...
              ImageUrl="~/images/changepwdicon1.jpg" Width="650px" />
